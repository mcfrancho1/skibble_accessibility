...
class UserKitchenPrimaryContactDetails extends StatefulWidget {
  const UserKitchenPrimaryContactDetails({Key? key,}) : super(key: key);

  @override
  State<UserKitchenPrimaryContactDetails> createState() => _UserKitchenPrimaryContactDetailsState();
}

class _UserKitchenPrimaryContactDetailsState extends State<UserKitchenPrimaryContactDetails> {
  final GlobalKey<FormState> _kitchenSignUpFormKey = GlobalKey<FormState>();
  //
  // String? email = "";
  // String? fullName = "";
  // String? userName = "";
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: Text("Join Skibble Kitchens.", style: TextStyle(
                                  ...
                                  Center(
                                    child: Text(
                                      'Register your food business as a Skibble Kitchen and connect with your customers easily.',
                                      ...
                                      return SizedBox(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () async{
                                              final form = _kitchenSignUpFormKey.currentState;
                                              ...
                                              if(form!.validate()) {
                                                ...
                                                SkibbleUser newSwiftMenuUser = SkibbleUser(
                                                  ...
                                                  kitchen: Kitchen(
                                                      ...
                                                      workExperienceList: [],
                                                      certificationsList: [],
                                                    primaryContactFullName: context.read<SkibbleAuthProvider>().fullName
                                                  ),
                                                  accountType: AccountType.kitchen,
                                                  isASkibbleRegisteredChef: true,
                                                  hasASkibbleKitchen: true
                                                );
                                                context.read<SkibbleAuthProvider>().fullName = null;
                                                context.read<SkibbleAuthProvider>().userName = null;
                                                print(newSwiftMenuUser.fullName);
                                                await AuthController().createUserAccountWithEmailAndPassword(newSwiftMenuUser, context, formState: _kitchenSignUpFormKey.currentState);
