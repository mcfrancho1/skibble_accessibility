...
class ChefQualificationsDetailsView extends StatefulWidget {
  const ChefQualificationsDetailsView({Key? key}) : super(key: key);

  @override
  State<ChefQualificationsDetailsView> createState() => _ChefQualificationsDetailsViewState();
}

class _ChefQualificationsDetailsViewState extends State<ChefQualificationsDetailsView> {
    ...
    return Column(
      ...
      children: [
              ...
              child: Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This section helps us know if you have undergone a food hygiene program in your county and if you have a government approved food license.',
        ...
        ControlButtons(
          ...
          onNextPressed: () async{
            // print(userChef?.chef!.serviceLocation);
            if(userChef != null) {
              ...
              if(res != null) {
                userChef.chef?.foodLicenseOrPermitDocUrl = res['foodLicense'];
                userChef.chef?.foodHandlerCertificationDocUrl = res['foodHandlerCertificate'];
