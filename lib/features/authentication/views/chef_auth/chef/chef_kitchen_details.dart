...
class ChefKitchenDetailsView extends StatefulWidget {
  const ChefKitchenDetailsView({Key? key}) : super(key: key);

  @override
  State<ChefKitchenDetailsView> createState() => _ChefKitchenDetailsViewState();
}

class _ChefKitchenDetailsViewState extends State<ChefKitchenDetailsView> {
  ...
  final GlobalKey<FormState> _chefKitchenDetailsFormKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    // var userChef = context.read<AuthProvider>().signUpChef;
    var address = Provider.of<AppData>(context,).userCurrentLocation;

    return Form(
      key: _chefKitchenDetailsFormKey,
      child: Column(
        ...
        children: [
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  readOnly: true,
                                  onTap: () {
                                    CustomPickers().showLocationPickerSheet(context, restrictedCountries: context.read<LocationPickerData>().skibbleChefCountries);
          ...
          ControlButtons(
            ...
            onNextPressed: () async{
              ...
              final form = _chefKitchenDetailsFormKey.currentState;
              ...
              if(form!.validate()) {
                ...
                if(userChef != null) {
                  ...
                  context.read<SkibbleAuthProvider>().signUpChef!.chef!.kitchenName = kitchenName;
                  context.read<SkibbleAuthProvider>().signUpChef!.chef!.serviceLocation = context.read<LocationPickerData>().pickedLocation;
                  ...
                  //
                  if(res == 'kitchen-name-exists') {
                    CustomBottomSheetDialog.showErrorSheet(context, 'This kitchen name already exists! Please choose another name.', onButtonPressed: () {
