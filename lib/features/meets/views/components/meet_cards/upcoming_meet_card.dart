...
class UpcomingMeetCard extends StatelessWidget {
  const UpcomingMeetCard({Key? key, required this.meet}) : super(key: key);
                ...
                Positioned(
                  ...
                  child: Center(
                    child: TimerCountdown(
                      ...
                      timeTextStyle: const TextStyle(color: kLightSecondaryColor, fontWeight: FontWeight.bold),
                      colonsTextStyle: const TextStyle(color: kLightSecondaryColor, fontWeight: FontWeight.bold),
                      descriptionTextStyle: const TextStyle(color: kLightSecondaryColor, fontWeight: FontWeight.bold),

                      spacerWidth: 5,
                      endTime:  DateTime.fromMillisecondsSinceEpoch(meet.meetDateTime),
                      onEnd: () {
