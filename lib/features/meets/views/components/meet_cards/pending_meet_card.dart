...
class PendingMeetCard extends StatelessWidget {
  const PendingMeetCard({Key? key, required this.meet}) : super(key: key);
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      //             ),
                      //             child: const Center(child: Icon(SkibbleCustomIcons.noun_hand_wave, size: 40, color: Colors.grey,)),
                      //             // SvgPicture.asset(
