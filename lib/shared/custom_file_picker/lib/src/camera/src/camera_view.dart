...
import 'package:skibble/shared/custom_file_picker/lib/src/camera/src/widgets/camera_builder.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/camera/src/widgets/camera_overlay.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/camera/src/widgets/raw_camera_view.dart';
  ...
  void initState() {
    ...
    _camController = (widget.controller ?? CamController())
      ..init(
        ...
        // galleryController: context.galleryController!,
      );
    ...
    return Stack(
      children: [
        GalleryView(
          ...
          editText: controller.galleryController.setting.editText!,
          continueText: controller.galleryController.setting.continueText!,
          ...
          ), onPictureTaken: (XFile? cameraFile) {  },
        ),
