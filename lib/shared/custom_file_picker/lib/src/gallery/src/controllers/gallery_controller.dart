...
class GalleryController extends ValueNotifier<GalleryValue> {
  ...
  // Completer for gallery picker controller
  late Completer<List<SkibbleEntity>> _completer;
  ...
  void Function(SkibbleEntity entity, bool removed)? _onChanged;
  ...
  @internal
  Future<SkibbleEntity?> openCamera(BuildContext context) async {
    final uiHandler = UIHandler.of(context);

    final route = SlideTransitionPageRoute<List<SkibbleEntity>>(
      builder: CameraView(
  ...
  @internal
  Future<SkibbleEntity?> editEntity(
    BuildContext context,
    SkibbleEntity entity,
  ) async {
    //
  ...
  @internal
  Future<List<SkibbleEntity>> onGalleryFieldPressed(
    BuildContext context, {
    void Function(SkibbleEntity entity, bool removed)? onChanged,
  ...
  Future<List<SkibbleEntity>> _collapsableGallery(BuildContext context) {
    _completer = Completer<List<SkibbleEntity>>();
  ...
  @internal
  List<SkibbleEntity> completeTask(
    BuildContext context, {
    List<SkibbleEntity>? items,
  }) {
  ...
  ///
  /// Pick assets
  Future<List<SkibbleEntity>> pick(
    BuildContext context, {
    GallerySetting? setting,
    CustomRouteSetting? routeSetting,
  ...
  Future<List<SkibbleEntity>> recentEntities({
    RequestType? type,
    int count = 1,
  }) {
    final albums = Albums();
