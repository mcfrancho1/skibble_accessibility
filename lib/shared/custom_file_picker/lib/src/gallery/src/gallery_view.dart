...
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/repo/gallery_repository.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/widgets/albums_page.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/widgets/gallery_asset_selector.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/widgets/gallery_grid_view.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/widgets/gallery_header.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/widgets/panel_setting_builder.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/gallery/src/widgets/send_button.dart';
...
class GalleryView extends StatefulWidget {
  ...
  ///
  /// Pick media
  static Future<List<SkibbleEntity>?> pick(
    ...
    Function(XFile? cameraFile)? onPictureTaken,

    /// Route setting
    CustomRouteSetting? routeSetting,
  }) {
    return Navigator.of(context).push<List<SkibbleEntity>>(
      SlideTransitionPageRoute(
        builder: GalleryView(
          controller: controller,
          setting: setting,
          editText: setting!.editText!,
          continueText: setting.continueText!,
...
//
                    ...
                    Expanded(
                      child: GalleryGridView(
                        controller: _controller,
                        albums: _albums,
                        onClosePressed: _onClosePressed, onPictureTaken: widget.onPictureTaken,
                      ),
                    ),
                  ],
                ),
