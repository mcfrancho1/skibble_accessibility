...
class _AlbumTile extends StatelessWidget {
  ...
  Future<AssetEntity?> _entity() async {
    final assets =
        (await album.value.assetPathEntity?.getAssetListPaged(page: 0, size : 1)) ?? [];
            ...
            Container(
              ...
              child: FutureBuilder<AssetEntity?>(
                ...
                builder: (context, snapshot) {
                  ...
                  return ColoredBox(
                    color: Colors.grey.shade800,
                    child: EntityThumbnail(entity: snapshot.data!.toSkibble),
                  );
                },
              ),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // Total photos
                  Text(
                    album.value.assetPathEntity?.assetCountAsync.then((value) => value).toString() ?? '',
                    style: TextStyle(
