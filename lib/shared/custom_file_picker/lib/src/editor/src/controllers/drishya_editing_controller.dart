...
import '../widgets/draggable_resizable.dart';
...
class DrishyaEditingController extends ValueNotifier<EditorValue> {
  ...
  Future<SkibbleEntity?> completeEditing({
    ...
    try {
      ...
      if (bg is DrishyaBackground && !value.hasStickers) {
        ...
        final entity = await PhotoManager.editor.saveImage(bg.bytes, title: '');
        return entity?.toSkibble;
      } else {
