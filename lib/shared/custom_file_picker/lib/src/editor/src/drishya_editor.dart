...
import 'package:skibble/shared/custom_file_picker/lib/src/editor/src/widgets/color_picker.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/editor/src/widgets/editor_overlay.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/editor/src/widgets/editor_textfield.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/editor/src/widgets/editor_textfield_button.dart';
import 'package:skibble/shared/custom_file_picker/lib/src/editor/src/widgets/stickers_view.dart';
...
class DrishyaEditor extends StatefulWidget {
  ...
  /// Open drishya editor
  static Future<SkibbleEntity?> open(
    BuildContext context, {
    DrishyaEditingController? controller,
    EditorSetting? setting,
    bool hideOverlay = false,
  }) async {
    return Navigator.of(context).push<SkibbleEntity>(
