...
class CustomSwipeTo extends StatefulWidget {
  ...
  @override
  _CustomSwipeToState createState() => _CustomSwipeToState();
}

class _CustomSwipeToState extends State<CustomSwipeTo> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
